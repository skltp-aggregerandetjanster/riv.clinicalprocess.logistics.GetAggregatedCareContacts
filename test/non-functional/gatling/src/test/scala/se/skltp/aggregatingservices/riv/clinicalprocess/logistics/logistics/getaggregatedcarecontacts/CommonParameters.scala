...
trait CommonParameters {
  ...
  val urn:String             = "urn:riv:ehr:patientsummary:GetCareContactsResponder:2"
  val responseElement:String = "GetCareContactsResponse"
  val responseItem:String    = "careContact"
  val responseItemUrn:String = "urn:riv:clinicalprocess:logistics:logistics:GetCareContactsResponder:2"
